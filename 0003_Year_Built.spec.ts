...
test('TC_Ast_List_Ftr_0006', async ({ page }) => { 
...
const filterPanel = page.locator('[role="dialog"], .clr-popover-content, .datagrid-filter');
  await page.getByRole('columnheader', { name: /Year Built/i })
  .locator('.datagrid-filter-toggle')
  .click();
    await filterPanel.first().waitFor({ state: 'visible', timeout: 50000 });
    await page.waitForLoadState('networkidle');
    //click screenshot
    await expect(page).toHaveScreenshot('TC_0006.png', {
        fullPage: true,
        animations: 'disabled'
    });
    ...
    // input the value
    await filterInputSite.fill('2001');
    ...
    await expect(page).toHaveScreenshot('TC_0007.png', {
        fullPage: true,
        animations: 'disabled'
    });
  ...
  .click();
    ...
    const yearColumn = page.locator('clr-dg-column:has-text("Year Built")');
    ...
    // click the screenshot
    await expect(page).toHaveScreenshot('TC_0008.png', {
        fullPage: true,
        animations: 'disabled'
    });
...
await expect(page).toHaveScreenshot('TC_0010_a.png', {
        fullPage: true,
        animations: 'disabled'
    });
...
await page.waitForLoadState('networkidle');
await expect(page).toHaveScreenshot('TC_0010_b.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await page.getByRole('columnheader', { name: /Year Built/i })
...
await filterInputSite.fill('1980');
await expect(page).toHaveScreenshot('TC_0009_a.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await searchButton.click();
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('TC_0009_b.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await page.getByRole('columnheader', { name: /Year Built/i })
