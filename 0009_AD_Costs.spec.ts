...
test('TC_Ast_List_Ftr_0036', async ({ page }) => { 
...
const filterPanel = page.locator('[role="dialog"], .clr-popover-content, .datagrid-filter');
  await page.getByRole('columnheader', { name: /Additional detour costs/i })
  .locator('.datagrid-filter-toggle')
  .click();
    await filterPanel.first().waitFor({ state: 'visible', timeout: 50000 });
    await page.waitForLoadState('networkidle');
    //click screenshot
    await expect(page).toHaveScreenshot('TC_0036.png', {
        fullPage: true,
        animations: 'disabled'
    });
    ...
    // input the value
    await filterInputSite.fill('50000');
    ...
    await expect(page).toHaveScreenshot('TC_0039.png', {
        fullPage: true,
        animations: 'disabled'
    });
...
await expect(page).toHaveScreenshot('TC_0037_a.png', {
        fullPage: true,
        animations: 'disabled'
    });
...
await page.waitForLoadState('networkidle');
await expect(page).toHaveScreenshot('TC_0037_b.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await page.getByRole('columnheader', { name: /Additional detour costs/i })
...
await filterInputSite.fill('50000');
await expect(page).toHaveScreenshot('TC_0038_a.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await searchButton.click();
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('TC_0038_b.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await page.getByRole('columnheader', { name: /Additional detour costs/i })
