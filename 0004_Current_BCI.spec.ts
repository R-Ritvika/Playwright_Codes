...
test('TC_Ast_List_Ftr_0011', async ({ page }) => { 
...
const filterPanel = page.locator('[role="dialog"], .clr-popover-content, .datagrid-filter');
  await page.getByRole('columnheader', { name: /Current BCI/i })
  .locator('.datagrid-filter-toggle')
  .click();
    await filterPanel.first().waitFor({ state: 'visible', timeout: 50000 });
    await page.waitForLoadState('networkidle');
    //click screenshot
    await expect(page).toHaveScreenshot('TC_0011.png', {
        fullPage: true,
        animations: 'disabled'
    });
    ...
    // input the value
    await filterInputSite.fill('72.96');
    ...
    await expect(page).toHaveScreenshot('TC_0013.png', {
        fullPage: true,
        animations: 'disabled'
    });
  ...
  .click();
    ...
    const yearColumn = page.locator('clr-dg-column:has-text("Current BCI")');
    ...
    // click the screenshot
    await expect(page).toHaveScreenshot('TC_0014.png', {
        fullPage: true,
        animations: 'disabled'
    });
...
await expect(page).toHaveScreenshot('TC_0015_a.png', {
        fullPage: true,
        animations: 'disabled'
    });
...
await page.waitForLoadState('networkidle');
await expect(page).toHaveScreenshot('TC_0015_b.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await page.getByRole('columnheader', { name: /Current BCI/i })
...
await filterInputSite.fill('74.55');
await expect(page).toHaveScreenshot('TC_0012_a.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await searchButton.click();
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('TC_0012_b.png', {
        fullPage: true,
        animations: 'disabled'
    });
    await page.getByRole('columnheader', { name: /Current BCI/i })
